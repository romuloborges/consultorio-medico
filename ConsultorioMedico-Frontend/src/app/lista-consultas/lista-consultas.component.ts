...
export class ListaConsultasComponent implements OnInit {
  ...
  editarConsulta(i: number) {
    ...
    let consulta = new ConsultaAgendamentoListagem(this.dataSource.data[i].idConsulta, this.dataSource.data[i].dataHoraTerminoConsulta, this.dataSource.data[i].receitaMedica);
